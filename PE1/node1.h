...
namespace main_savitch_5
{
	...
	void list_clear(node*& head_ptr);
	void list_copy(const node* source_ptr, node*& head_ptr, node*& tail_ptr);
	void list_print(node * headPtr); // function to print the list of current nodes
	void list_showStatistics(node *headPtr); // function to show the largest, smallest, average, and sum of all nodes in the current linked list
